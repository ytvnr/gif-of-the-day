...
image::../../../images/gh-actions-where.png[GHActions,2000]

=== Pull request labeler

Using Actions from marketplace

image::../../../images/gh-actions-pr-labeler.png[GHActions,2000]
...
image::../../../images/gh-actions-deploy-staging.png[GHActions,700]
